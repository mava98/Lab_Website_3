...
app.get('/home', function(req, res) {
	...
	db.any(query)
        ...
        .catch(function (err) {
            ...
            console.log; //if this doesn't work for you replace with console.log
            res.render('pages/home', {
                title: 'Home Page',
                data: '',
                color: '',
...
app.get('/team_stats', function(req, res) {
	var football_games  =  'select * from football_games;';
        var winning_games = 'SELECT COUNT(home_score) AS "numWins" FROM football_games WHERE home_score > visitor_score;';
	var losing_games = 'SELECT COUNT(visitor_score) AS "numLosses" FROM football_games WHERE home_score < visitor_score;';
	db.task('get-everything', task => {
	return task.batch([
	   ...
	   task.any(losing_games);
        ...
        res.render('pages/team_stats',{
                                my_title: "Team Stats",
                                numGames: info[0],
                                numWins: winning_games,
                                numLosses: losing_games,
                        })
    })
    .catch(error => {
        // display error message in case an error
